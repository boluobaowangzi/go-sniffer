...
// avoids memory allocation.  Used pages are stored in a doubly-linked list in a
// connection.
type page struct {
...
// that a single stream receives its data serially. It is safe for concurrency,
// usable by multiple Assemblers at once.
//
